import{_ as e,Y as i,Z as n,a2 as d}from"./framework-d651fda7.js";const l={},s=d(`<h2 id="数组" tabindex="-1"><a class="header-anchor" href="#数组" aria-hidden="true">#</a> 数组</h2><h3 id="算法学习-代码随想录算法总结-c-版本——数组、链表-704-二分查找" tabindex="-1"><a class="header-anchor" href="#算法学习-代码随想录算法总结-c-版本——数组、链表-704-二分查找" aria-hidden="true">#</a> [[算法学习/代码随想录算法总结(C++)版本——数组、链表#704 二分查找]]</h3><p>版本一）左闭右闭区间</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>class Solution:
