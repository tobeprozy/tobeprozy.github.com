import{_ as n,Y as s,Z as a,a2 as t}from"./framework-d651fda7.js";const p={},e=t(`<p>::: tips 查找算法 :::</p><ul><li><p><strong>find_if(iterator beg, iterator end, _Pred);</strong></p><div class="language-cpp line-numbers-mode" data-ext="cpp"><pre class="language-cpp"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span><span class="token string">&lt;iostream&gt;</span></span>
