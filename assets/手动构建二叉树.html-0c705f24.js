import{_ as e,Y as i,Z as t,a2 as c}from"./framework-39b9cf04.js";const n="/assets/1-c351575c.png",o="/assets/3-70010208.png",a="/assets/4-090cfc5d.png",p="/assets/5-5e5da44f.png",s="/assets/6-1b8f240e.png",r={},_=c('<p>::: tips 二叉树手动构建 :::</p><ul><li><p>二叉树手动构建</p><p>已知前序遍历序列和中序遍历序列，可以唯一确定一棵二叉树。 已知后序遍历序列和中序遍历序列，可以唯一确定一棵二叉树。 但是已知前序遍历序列和后序遍历序列，是不能确定一棵二叉树的。 下面例子通过前序遍历和中序遍历确定唯一的一棵二叉树。</p><p>前序遍历：EACBDGF</p><p>中序遍历：ABCDEFG</p><p>1、首先根据前序遍历找出根节点是E，然后根据中序遍历可以知道ABCD是E的左子树，FG是E的右子树。</p></li></ul><figure><img src="'+n+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><pre><code>2、然后根据左子树的先序：ACBD，中序：ABCD，确定A为根结点，无左子树，右子树为BCD
