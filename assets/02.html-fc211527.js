import{_ as n,Y as s,Z as e,a2 as i}from"./framework-d651fda7.js";const a={},l=i(`<h1 id="每日一问—02如何实现pdf合并" tabindex="-1"><a class="header-anchor" href="#每日一问—02如何实现pdf合并" aria-hidden="true">#</a> 每日一问—02如何实现PDF合并？</h1><h2 id="python版本" tabindex="-1"><a class="header-anchor" href="#python版本" aria-hidden="true">#</a> python版本</h2><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> PyPDF2
