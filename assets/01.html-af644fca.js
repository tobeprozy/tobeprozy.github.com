import{_ as n,Y as s,Z as a,a2 as e}from"./framework-d651fda7.js";const t={},i=e(`<h1 id="每日一问—01如何在指定目录下的文件名前面加上-0-序号" tabindex="-1"><a class="header-anchor" href="#每日一问—01如何在指定目录下的文件名前面加上-0-序号" aria-hidden="true">#</a> 每日一问—01如何在指定目录下的文件名前面加上“0”+序号</h1><h2 id="python版本" tabindex="-1"><a class="header-anchor" href="#python版本" aria-hidden="true">#</a> python版本</h2><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> os
